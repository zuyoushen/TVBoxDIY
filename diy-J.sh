...
cd $CURRENT_DIR/$DIR
#共存
sed -i 's/com.github.tvbox.osc/com.github.tvbox.osc.py/g' $CURRENT_DIR/$DIR/app/build.gradle
#签名
...
#xwalk修复
sed -i 's/home.jundie.top:81\/xwalk\/maven2/raw.githubusercontent.com\/zuyoushen\/TVBoxDIY\/main/g' $CURRENT_DIR/$DIR/build.gradle
#sed -i 's/download.01.org\/crosswalk\/releases\/crosswalk\/android\/maven2/raw.githubusercontent.com\/zuyoushen\/TVBoxDIY\/main/g' $CURRENT_DIR/$DIR/build.gradle
#名称修改
sed -i 's/TVBox/PyBox/g' $CURRENT_DIR/$DIR/app/src/main/res/values/strings.xml
#图标修改
cp $CURRENT_DIR/DIY/app_icon_192.png $CURRENT_DIR/$DIR/app/src/main/res/drawable-hdpi/app_icon.png
...
#添加PY支持
wget --no-check-certificate -qO- "https://raw.githubusercontent.com/zuyoushen/TVBoxDIY/main/py/pyramid-1011.aar" -O $CURRENT_DIR/$DIR/app/libs/pyramid.aar
